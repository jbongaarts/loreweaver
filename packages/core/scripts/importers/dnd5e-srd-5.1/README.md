...
fall to the document-structure default; and the single genuinely dropped item —
the Oath of Devotion's "Tenets of Devotion" prose — is held under a narrow
`known-gap:eshyra-citg` (subclass body parser). The Appendix PH-B deity tables
