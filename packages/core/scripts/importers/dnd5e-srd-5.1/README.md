...
| `monsters`           | `/^Monsters$/`                                 | `/^(Nonplayer Characters\|NPCs\|Appendix\|Open Game License\|Legal Information)\b/i` | false (may run to EOF) |
