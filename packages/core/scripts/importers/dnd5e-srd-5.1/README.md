...
named section on that record — eshyra-citg). The Appendix PH-B deity tables
and Half-Dragon Template tables stay with eshyra-4a7.10 (their unimported
regions), and the nine spell-embedded tables (Animated Object Statistics,
Confusion, Control Weather, Creation, Reincarnate, Scrying, Teleport) with
eshyra-o4j7. A
